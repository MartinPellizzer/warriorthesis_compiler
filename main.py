    ...
    <header>
        <nav class="container-xl mx-auto px-32">
            ...
            <ul>
                ...
                <li><a href="bullly-bending-secrets.html">Bully-Bending Secrets</a></li>
...
generate_post('how-to-spot-the-signs-of-bullying.html')
generate_post('psychological-impact-mental-health-bullying.html')
generate_post('workplace-bullying-problem.html')
# generate_assets()
# generate_homepage()